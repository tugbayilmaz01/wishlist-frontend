        ...
        <div className={styles.minimalOnboarding}>
          ...
          <div className={styles.onboardingContent}>
            <div className={styles.brandIconWrapper}>
              <svg className={styles.brandIcon} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M50 82C50 82 18 64 18 42C18 32 23 25 32 25C38 25 44 29 50 36C56 29 62 25 68 25C77 25 82 32 82 42C82 64 50 82 50 82Z" fill="#38161f" />
                <path d="M18 18L20 24L26 26L20 28L18 34L16 28L10 26L16 24L18 18Z" fill="#ff425d" className={`${styles.sparkleStar} ${styles.star1}`} />
                <path d="M82 18L84 24L90 26L84 28L82 34L80 28L74 26L80 24L82 18Z" fill="#FFD700" className={`${styles.sparkleStar} ${styles.star2}`} />
                <path d="M90 48L92 53L97 55L92 57L90 62L88 57L83 55L88 53L90 48Z" fill="#ff425d" className={`${styles.sparkleStar} ${styles.star3}`} />
                <path d="M68 78L70 83L75 85L70 87L68 92L66 87L61 85L66 83L68 78Z" fill="#FFD700" className={`${styles.sparkleStar} ${styles.star4}`} />
                <path d="M32 78L34 83L39 85L34 87L32 92L30 87L25 85L30 83L32 78Z" fill="#ff425d" className={`${styles.sparkleStar} ${styles.star5}`} />
                <path d="M10 48L12 53L17 55L12 57L10 62L8 57L3 55L8 53L10 48Z" fill="#FFD700" className={`${styles.sparkleStar} ${styles.star6}`} />
              </svg>
            </div>
