export const translations = {
  en: {
    common: {
      ...
      userNotFound: "The person you want to invite is not on Wishtra yet.",
      invite: "Invite",
      remove: "Remove",
  ...
  tr: {
    common: {
      ...
      shared: "Paylaşılan",
      sharedBy: "Sahibi:",
      userNotFound: "Davet etmek istediğin kişi henüz Wishtra'da değil.",
      invite: "Davet Et",
      remove: "Kaldır",
